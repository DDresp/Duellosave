...
struct LocalSingleImagePost: LocalSingleImagePostModel {
    ...
    var typeData: PostAttribute = PostAttribute(attributeType: .type, value: FineMediaEnum.localSingleImage)
    var imageUrl: PostAttribute = PostAttribute(attributeType: .imageUrl, value: nil)
