...
struct LocalImagesPost: LocalImagesPostModel {
    ...
    var imageUrls: PostAttribute = PostAttribute(attributeType: .imageUrls, value: [String]())
    var typeData: PostAttribute = PostAttribute(attributeType: .type, value: FineMediaEnum.localImages)
