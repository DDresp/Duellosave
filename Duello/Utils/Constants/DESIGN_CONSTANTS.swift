...
let VERYSMALLFONTSIZE: CGFloat = 14
let EXTREMESMALLFONTSIZE: CGFloat = 11

//FONTS
let BOLDFONT = "HelveticaNeue-Medium"
let MEDIUMFONT = "HelveticaNeue"
