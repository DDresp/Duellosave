...
class UploadUserTableViewCell: UITableViewCell, UITextFieldDelegate {
    ...
    private func setupIconImageView() {
        ...
        iconImageView.anchor(top: iconImageViewContainer.topAnchor, leading: iconImageViewContainer.leadingAnchor, bottom: iconImageViewContainer.bottomAnchor, trailing: iconImageViewContainer.trailingAnchor, padding: .init(top: 0, left: STANDARDSPACING, bottom: 0, right: 0))
